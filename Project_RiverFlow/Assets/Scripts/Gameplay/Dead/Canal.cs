...
namespace Obselite
{
    ...
    public struct Canal
    {
        ...
        public Canal(GameTile _startNode, GameTile _endNode, List<GameTile> _tiles, FlowStrenght _riverStrengfht = FlowStrenght._00_)
        {
        ...
        public static Canal Inverse(Canal canal, GameGrid grid)
        {
            ...
            temp.Reverse();
            return new Canal(grid.GetTile(canal.endNode.gridPos), grid.GetTile(canal.startNode.gridPos), canal.tiles, canal.riverStrenght);
        }
        ...
        public void ChangeFlowStrenght(FlowStrenght newRiverStrenght)
        {
